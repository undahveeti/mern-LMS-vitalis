...
import { addAnswer, addQuestion, addReplyToReview, addReview, editCourse, getCourses, getAllCourses, getCourseByUser, getSingleCourse, uploadCourse, deleteCourse } from "../controllers/course.controller";
